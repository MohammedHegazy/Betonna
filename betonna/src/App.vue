...
export default {
  ...
  methods: {
    change_font_ar() {
      ...
      r.style.setProperty("--font", "expoarabic");
...
@font-face {
  ...
  src: url("assets/Expo_Arabic/Expo_Arabic_Light/Expo_Arabic_Light.ttf");
}
@font-face {
  font-family: expoenglish;
  src: url(assets/Expo_English/Roboto-Medium.ttf);
}
