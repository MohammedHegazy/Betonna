  ...
  <div class="specialcities-card">
    <div
      ...
      style="
        ...
        align-items: center;
        background: linear-gradient(rgba(0, 0, 0, 0.62), #2c2b2b);
        border: none;
      "
    >
      <div class="card-img-top">
        <img
          ...
          style="border-radius: 30px; width: 290px; height: 239px; opacity: 0.3"
        />
      </div>
